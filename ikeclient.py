...
class IKEv1Client(object):
    ...
    dicEType = {'1': 'DES-CBC', '2': 'IDEA-CBC', '3': 'Blowfish-CBC', '4': 'RC5-R16-B64-CBC', '5': '3DES-CBC',
                '6': 'CAST-CBC', '7': 'AES-CBC', '8': 'CAMELLIA-CBC'}
    dicAType = {'1': 'PSK', '2': 'DSS-Sig', '3': 'RSA-Sig', '4': 'RSA-Enc', '5': 'Revised RSA-Enc',
                '64221': 'Hybrid Mode', '65001': 'XAUTHInitPreShared'}
    dicHType = {'1': 'MD5', '2': 'SHA', '3': 'Tiger', '4': 'SHA2-256', '5': 'SHA2-384', '6': 'SHA2-512'}
    dicDHGroup = {'1': 'default 768-bit MODP group', '2': 'alternate 1024-bit MODP group',
    ...
    def payBuild(self, strPayload, lenLen, *arg):
        ...
        try:
            ...
            if arg[0] and lenLen <= 2:
                ...
                arrayPayload = array.array('B', bytes.fromhex((strPayload)))
            else:
    ...
    def ikeHeader(self, payNext, iCookie, rCookie, version, flags, xType, msgID,
                  payloads):  # Input the payload length to this method for now, need to figure out a calculation for this later
    ...
    def ikeDelete(self, payNext, iCookie, rCookie):
        ...
        arraypayLen = array.array('B', bytes.fromhex(fullpayLen))
    ...
    def main(self, iCookie, rCookie, eType, hashType, authType, DHGroup, IDdata, flags, target, idType, sport, keyLen):
        ...
        if eType == "07" or int(eType) == 7 or eType == "AES":
            arrayTrans = ikeneg.ikeTransform(eType, hashType, authType, DHGroup, "01", "00007080", "01", phase, "00",
                                             keyLen)  # static lifetime values for now
        else:
            arrayTrans = ikeneg.ikeTransform(eType, hashType, authType, DHGroup, "01", "00007080", "01", phase, "00")
        ...
        # SA
        arraySA = ikeneg.ikeSA(bytesProposal.hex())  # +bytesTrans.encode('hex'))
        ...
        # ID payload
        arrayID, ID_i = ikeneg.ikeID(IDdata, idType, "01f4", "11",
        ...
        arrayIKE = ikeneg.ikeHeader("01", iCookie, rCookie, version, flags, "04", "00000000", payloads.hex())
        ...
        dicCrypto = {"iCookie": iCookie, "rCookie": rCookie, "eType": eType, "hashType": hashType, "authType": authType,
                     "DHGroup": DHGroup, "nonce_i": nonce, "SA_i": SA_i, "ID_i": ID_i, "privKey": privKey,"DHPubKey_i":hexPubKey}
        return dicCrypto