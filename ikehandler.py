...
class IKEv1Handler(object):
    ...
    dicPayloads = {'0': 'NONE', '1': 'Security Association (SA)', '2': 'Proposal (P)', '3': 'Transform (T)',
                   '4': 'Key Exchange (KE)', '5': 'Identification (ID)', '6': 'Certificate (CERT)',
                   '7': 'Certificate Request (CR)', '8': 'Hash (HASH)', '9': 'Signature (SIG)', '10': 'Nonce (NONCE)',
                   '11': 'Notification (N)', '12': 'Delete (D)', '13': 'Vendor ID (VID)', '14': 'Mode CFG Attributes',
                   '15': 'SA KEK Payload (SAK)', '16': 'SA TEK Payload (SAT)', '17': 'Key Download (KD)',
                   '18': 'Sequence Number (SEQ)', '19': 'Proof of Possession (POP)', '20': 'NAT Discovery (NAT-D)',
                   '21': 'NAT Original Address (NAT-OA)', '22': 'Group Associated Policy (GAP)', '23-127': 'Unassigned',
                   '130': 'NAT-D', '128-255': 'Reserved for private use'}
    dicXTypes = {'0': 'NONE', '1': 'Base', '2': 'Identity Protection', '3': 'Authentication Only', '4': 'Aggressive',
                 '5': 'Informational', '6': 'Transaction (MODE-CFG)', '32': 'Quick Mode (QM)',
                 '33': 'New Group Mode (NGM)'}
    dicAtts = {'1': 'Encryption Algorithm', '2': 'Hash Algorithm', '3': 'Authentication Method',
               '4': 'Group Description', '5': 'Group Type', '6': 'Group Prime/Irreducible Polynomial',
               '7': 'Group Generator One', '8': 'Group Generator Two', '9': 'Group Curve A', '10': 'Group Curve B',
               '11': 'Life Type', '12': 'Life Duration', '13': 'PRF', '14': 'Key Length', '15': 'Field Size',
               '16': 'Group Order', '17-16383': 'Unassigned', '16384-32767': 'Reserved'}
    dicEType = {'0': 'Reserved', '1': 'DES-CBC', '2': 'IDEA-CBC', '3': 'Blowfish-CBC', '4': 'RC5-R16-B64-CBC',
                '5': '3DES-CBC', '6': 'CAST-CBC', '7': 'AES-CBC', '8': 'CAMELLIA-CBC'}
    dicAType = {'1': 'PSK', '2': 'DSS-Sig', '3': 'RSA-Sig', '4': 'RSA-Enc', '5': 'Revised RSA-Enc',
                '64221': 'Hybrid Mode', '65001': 'XAUTHInitPreShared', '65002': 'XAUTHRespPreShared',
                '65003': 'XAUTHInitDSS', '65004': 'XAUTHRespDSS', '65005': 'XAUTHInitRSA', '65006': 'XAUTHRespRSA',
                '65007': 'XAUTHInitRSAEncryption', '65008': 'XAUTHRespRSAEncryption',
                '65009': 'XAUTHInitRSARevisedEncryption', '65010': 'XAUTHRespRSARevisedEncryption'}
    dicHType = {'0': 'Reserved', '1': 'MD5', '2': 'SHA', '3': 'Tiger', '4': 'SHA2-256', '5': 'SHA2-384',
                '6': 'SHA2-512'}
    dicDHGroup = {'0': 'Reserved', '1': 'default 768-bit MODP group', '2': 'alternate 1024-bit MODP group',
                  '3': 'EC2N group on GP[2^155]', '4': 'EC2N group on GP[2^185]', '5': '1536-bit MODP group',
                  '6': 'EC2N group over GF[2^163](see Note)', '7': 'EC2N group over GF[2^163](see Note)',
                  '8': 'EC2N group over GF[2^283](see Note)', '9': 'EC2N group over GF[2^283](see Note)',
                  '10': 'EC2N group over GF[2^409](see Note)', '11': 'EC2N group over GF[2^409](see Note)',
                  '12': 'EC2N group over GF[2^571](see Note)', '13': 'EC2N group over GF[2^571](see Note)',
                  '14': '2048-bit MODP group', '15': '3072-bit MODP group', '16': '4096-bit MODP group',
                  '17': '6144-bit MODP group', '18': '8192-bit MODP group', '19': '256-bit random ECP group',
                  '20': '384-bit random ECP group', '21': '521-bit random ECP group',
                  '22': '1024-bit MODP Group with 160-bit Prime Order Subgroup',
                  '23': '2048-bit MODP Group with 224-bit Prime Order Subgroup',
                  '24': '2048-bit MODP Group with 256-bit Prime Order Subgroup', '25': '192-bit Random ECP Group',
                  '26': '224-bit Random ECP Group', '27': '224-bit Brainpool ECP group',
                  '28': '256-bit Brainpool ECP group', '29': '384-bit Brainpool ECP group',
                  '30': '512-bit Brainpool ECP group'}
    dicLType = {'1': 'seconds', '2': 'kilobytes'}
    dicIDType = {'0': 'ID_IPV4_ADDR', '1': 'ID_IPV4_ADDR_SUBNET', '2': 'ID_IPV6_ADDR', '3': 'ID_IPV6_ADDR_SUBNET',
                 '36136': 'R-U-THERE', '36137': 'R-U-THERE-ACK'}
    dicNotType = {'1': 'INVALID-PAYLOAD-TYPE', '2': 'DOI-NOT-SUPPORTED', '3': 'SITUATION-NOT-SUPPORTED',
                  ...
                  '24576': 'STATUS_RESP_LIFETIME', '36136': 'R-U-THERE', '36137': 'R-U-THERE-ACK'}
    dicMCFGType = {'0': 'RESERVED', '1': 'ISAKMP_CFG_REQUEST', '2': 'ISAKMP_CFG_REPLY', '3': 'ISAKMP_CFG_SET',
                   '4': 'ISAKMP_CFG_ACK', '5-127': 'Reserved for Future Use', '128-255': 'Reserved for Private Use'}
    dicMCFGAtt = {'0': 'RESERVED', '1': 'INTERNAL_IP4_ADDRESS', '2': 'INTERNAL_IP4_NETMASK', '3': 'INTERNAL_IP4_DNS',
                  '4': 'INTERNAL_IP4_NBNS', '5': 'INTERNAL_ADDRESS_EXPIRY', '6': 'INTERNAL_IP4_DHCP',
                  '7': 'APPLICATION_VERSION', '13': 'INTERNAL_IP4_SUBNET',
                  '14': 'SUPPORTED_ATTRIBUTES'}  # missing ipv6 values
    dicXAUTHAtts = {'16520': 'XAUTH_TYPE', '16521': 'XAUTH_USER_NAME', '16522': 'XAUTH_USER_PASSWORD',
                    '16523': 'XAUTH_PASSCODE', '16524': 'XAUTH_MESSAGE', '16525': 'XAUTH_CHALLENGE',
                    '16526': 'XAUTH_DOMAIN', '16527': 'XAUTH_STATUS'}
    dicXAUTHTypes = {'0': 'Generic', '1': 'RADIUS-CHAP', '2': 'OTP', '3': 'S/KEY', '4-32767': 'Reserved for future use',
                     '32768-65535': 'Reserved for private use'}
    dicIDESP = {'0': 'Reserved', '1': 'ENCR_DES_IV64', '2': 'ENCR_DES', '3': 'ENCR_3DES', '4': 'ENCR_RC5',
                '5': 'ENCR_IDEA', '6': 'ENCR_CAST', '7': 'ENCR_BLOWFISH', '8': 'ENCR_3IDEA', '9': 'ENCR_DES_IV32',
                '10': 'Reserved', '11': 'ENCR_NULL', '12': 'ENCR_AES_CBC', '13': 'ENCR_AES_CTR', '14': 'ENCR_AES-CCM_8',
                '15': 'ENCR-AES-CCM_12', '16': 'ENCR-AES-CCM_16', '17': 'Unassigned'}
    dicAttsESP = {'0': 'Reserved', '1': 'SA Life Type', '2': 'SA Life Duration', '3': 'Group Description',
                  '4': 'Encapsulation Mode', '5': 'Authentication Algorithm', '6': 'Key Length', '7': 'Key Rounds'}
    dicEncModeTypeESP = {'0': 'Reserved', '1': 'Tunnel', '2': 'Transport'}
    dicATypeESP = {'0': 'Reserved', '1': 'HMAC-MD5', '2': 'HMAC-SHA', '3': 'DES-MAC', '4': 'KPDK'}
    dicCertType = {'0': 'NONE', '1': 'PKCS7 wrapped X.509 certificate', '2': 'PGP Certificate', '3': 'DNS Signed Key',
                   '4': 'X.509 Certificate - Signature', '5': 'X.509 Certificate - Key Exchange',
                   '6': 'Kerberos Tokens', '7': 'Certificate Revocation List CRL', '8': 'Authority Revocation List ARL',
                   '9': 'SPKI Certificate', '10': 'X.509 Certificate - Attribute'}
    ...
    def transformCalculations(self, hexPacket, payLen, phase):
        ...
        while numAtts < finByte:
            ...
            if hexPacket[numAtts:numAtts + 2] == "80":
                ...
                transAtts.append(
                    hexPacket[numAtts:numAtts + 8 + (transLen * 2)])  # 8 = the 4 bytes used for the length value
                if self.debug > 0:
        ...
        while atts < finByte:
            ...
            if attXAUTH == 16527 or attXAUTH == 16520:
                ...
                if self.debug > 0:
                    ...
                    print("Mode Config Attribute Value: %s (%s)" % (bytes.fromhex(attXAUTHValue), attXAUTHValue))
                if len(attXAUTHValue) == 8:
                    dicCrypto["MCFG_IPi"] = attXAUTHValue
                    ip = str(int(attXAUTHValue[:2], 16)) + "." + str(int(attXAUTHValue[2:4], 16)) + "." + str(
                        int(attXAUTHValue[4:6], 16)) + "." + str(int(attXAUTHValue[6:8], 16))
    ...
    def parsePayload(self, hexPacket, nextPay, flags, finByte, phase):
        ...
        while nextPay != 0:
            if nextPay == 1:
                ...
                print("Next Payload %s - Support for multiple transform sets not added yet" % self.dicPayloads[
                    str(nextPay)])
                exit()
                ...
                attsXAUTH = ikeMCFG[-2]
                for key, value in attsXAUTH.items():
                    if key == 16527:
                ...
                print(
                    "Error: Invalid 'next payload', something went wrong. Perhaps an invalid next payload type or support for this payload is not added yet.\nThis is usually caused by an invalid payload decryption due to invalid IV or key.\nDebug output:\nNext Payload: %s" % nextPay)
    ...
    def main(self, hexPacket, encType, hashType, *args):
        if len(args) != 0 and len(args) != 3:
            print(
                "ikeHandler needs either packet, encryption type, hash type, or all of those with encryption Key, initial IV, last Current IV arguments. Exiting...")
            exit()
        elif len(args) == 3:
        ...
        if flags == "01":
            ...
            rawencPayload = bytes.fromhex(encPayload)
            ...
            if msgID == "00000000":
                ...
                ikeDecrypt = ikeCrypto.ikeCipher(encKey, bytes.fromhex(initIV), encType)
                ikePlain = ikeDecrypt.decrypt(rawencPayload).hex()
                if self.debug > 0:
